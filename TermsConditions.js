...
export default function TermsConditions() {
  return (
    <div>
      <NavBar />
      <img src={terms} className="termsImage" />
      <div className="termsleft">
        <b >Terms &<br />Conditions</b><br />
      ...
      <div className="termstext">
        ...
        <b className="heading">Your Account and Responsibilities</b><br />
        ...
        <b className="heading">Your use of the Services must comply with our Rules.</b><br />
        ...
        <b className="heading">To use our Services, you must be at least 16 years old.</b><br />
        ...
        <b className="heading">User Content on the Services</b><br />
        ...
        <b className="heading">Rights and Ownership</b><br />
        <p style={{ fontSize: "18px", lineHeight: "35px" }}>JellyKi may review your conduct and content for compliance with these Terms and our Rules, and reserves the right to remove any <br />
        violating content.<br />
        JellyKi reserves the right to delete or disable content alleged to be infringing the intellectual property rights of others, and to terminate <br />
        accounts of repeat infringers. We respond to notices of alleged copyright infringement if they comply with the law; please report such <br />
        ...
        NEBUTECH reserves the right to amend or modify this Privacy Policy at any time, as and when the need arises. We request you to visit our <br />
        website http://nebutech.company.in/ periodically for contemporary information and changes.</p><br />
        <b className="heading">Termination</b><br />
        ...
        <b className="heading">Transfer and Processing Data</b><br />
        ...
        <b className="heading">Indemnification</b><br />
        ...
        <b className="heading">Disclaimers — Service is “As Is”</b><br />
        ...
        <b className="heading">Limitation of Liability</b><br />
        ...
        <b className="heading">Resolving Disputes; Binding Arbitration</b><br />
        ...
        <b className="heading">Governing Law and Venue</b><br /><br />
        ...
        <b className="heading">Amendments</b><br />
        ...
        <b className="heading">Severability</b><br />
        ...
        <b className="heading">Miscellaneous</b><br />
