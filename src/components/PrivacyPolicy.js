...
export default function PrivacyPolicy() {
  return (
    <div>
  <NavBar/>
  <img src={privacy} style={{width:"100%",marginTop:"10px"}}/>
     <div  className="about1left"> 
      <b style={{ color:"#4FD84F",fontSize:"60px"}}>Privacy Policy</b>
      <ProgressBar  className="progress-bar" />
      </div>
      <div style={{marginLeft:"75px"}}>
      <h1>You are Information is <span style={{ color:"#4FD84F"}}>Safe</span></h1><br/>
      ...
      <h1>Collection of <span style={{ color:"#4FD84F"}}>Personal Information</span></h1><br/>
      ...
      <h1 style={{ color:"#4FD84F"}}>Disclosure and Transfer <span style={{ color:"black"}}>of Personal Information</span></h1><br/>
      ...
      Authorized Third Parties: NEBUTECH may at its discretion employ, contract or include third parties (as defined in section 1: Collection of<br/>
        ...
        <h1>Security <span style={{ color:"#4FD84F"}}>Practices and Procedures</span></h1><br/>
        ...
        <h1>Update of <span style={{ color:"#4FD84F"}}>Personal Information</span></h1><br/>
        ...
        <h1>Feedback and <span style={{ color:"#4FD84F"}}>Concerns</span></h1><br/>
